...
import com.example.springshop1.config.security.CustomPrincipal;
...
import com.example.springshop1.entity.repository.CartRepository;
...
public class CartView extends VerticalLayout {
    ...
    private void initCartGrid() {
        ...
        ListDataProvider<Product> dataProvider = DataProvider.ofCollection(cart.getProductList() != null ? cart.getProductList() : Collections.emptyList());
